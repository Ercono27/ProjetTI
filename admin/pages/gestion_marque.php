    ...
    <table class="table table-striped table-bordered">
        ...
        for($i=0; $i < $nbr; $i++){
            ...
            <tr>
                ...
                <td contenteditable="true" class="text-center" id="<?= $liste[$i]->id_marque;?>" name="nom_produit"><?= $liste[$i]->nom_marque;?></td>
                <td contenteditable="true" class="text-center" id="<?= $liste[$i]->id_marque;?>" name="image"><?= $liste[$i]->image;?></td>
