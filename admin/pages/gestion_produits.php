    ...
    <table class="table table-striped table-bordered">
        ...
        for ($i = 0; $i < $nbr; $i++) {
            ...
            <tr>
                ...
                <td contenteditable="true" class="text-center" id="<?= $liste[$i]->id_produit; ?>"
                    name="nom_produit"><?= $liste[$i]->nom_produit; ?></td>
                <td contenteditable="true" class="text-center" id="<?= $liste[$i]->id_produit; ?>"
                    name="prix"><?= $liste[$i]->prix; ?></td>
                <td contenteditable="true" class="text-center" id="<?= $liste[$i]->id_produit; ?>"
                    name="stock"><?= $liste[$i]->stock; ?></td>
                <td contenteditable="true" class="text-center" id="<?= $liste[$i]->id_produit; ?>"
                    name="nom_cat"><?= $liste[$i]->nom_cat; ?></td>
                <td contenteditable="true" class="text-center" id="<?= $liste[$i]->id_produit; ?>"
                    name="nom_marque"><?= $liste[$i]->nom_marque; ?></td>
                <td contenteditable="true" class="text-center" id="<?= $liste[$i]->id_produit; ?>"
                    name="image"><?= $liste[$i]->image; ?></td>
                <td contenteditable="true" class="text-center" id="<?= $liste[$i]->id_produit; ?>"
                    name="description"><?= $liste[$i]->description; ?></td>
